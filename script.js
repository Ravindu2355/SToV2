...
//Draggable.init(".player-controls");
...
function chooseVideo() {
    Swal.fire({
        ...
        html: `<div class="flexBtns">
                <button onclick='selectLocalVideo()' class='swal2-confirm swal2-styled'>Local File</button>
...
async function editSubtitle(index) {
    ...
    const { value: formValues } = await Swal.fire({
        ...
        didOpen: () => {
            ...
            modal.querySelector('.swal2-textarea').focus();
